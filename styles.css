...
/* Animación para tarjetas de moneda */
.currency-card {
...
.wheel-segment {
    ...
    top: 0;
    left: 0;
    clip-path: polygon(50% 50%, 50% 0%, 100% 0%); /* Forma base del triángulo */
    transform-origin: 50% 50%; /* Centro de la ruleta */
}
...
.wheel-segment span {
    ...
    left: 60%;
    transform: rotate(0deg); /* Se ajustará dinámicamente */
    color: white;
    font-weight: bold;
    font-size: 13px;
